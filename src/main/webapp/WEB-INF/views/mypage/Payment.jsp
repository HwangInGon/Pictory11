...
<div class="container">    
	...
	<ul>
		<li><a class="link-primary" href="<c:url value="/mypage/Bookmark.do"/>">결제</a></li>
		<li><a class="link-primary" href="<c:url value="/mypage/MyActivity.do"/>">내활동</a></li>
		<li><a class="link-primary" href="<c:url value="/mypage/Buy.do"/>">구매목록</a></li>
		<li><a class="link-primary" href="<c:url value="/mypage/Sell.do"/>">판매목록</a></li>
		<li><a class="link-primary" href="<c:url value="/mypage/Alarm.do"/>">알람</a></li>
	</ul>
